...
const VendorsListContent = () => {
  ...
  return (
    <>
      <Button onClick={toggleSidebar}>Add Vendor</Button>
      <p>
        ...
        who avoids a pain that produces no resultant pleasure?" Section 1.10.33 of "de Finibus
        Bonorum et Malorum", written by Cicero in 45 BC "At vero eos et accusamus et iusto odio
        ...
        the moment, so blinded by desire, that they cannot foresee the pain and trouble that are
